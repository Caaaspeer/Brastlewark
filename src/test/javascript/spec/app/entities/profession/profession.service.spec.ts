...
describe('Service Tests', () => {
    describe('Profession Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(ProfessionService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/professions';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a Profession', () => {
                service.create(new Profession(null)).subscribe(received => {
            ...
            it('should update a Profession', () => {
                service.update(new Profession(123)).subscribe(received => {
